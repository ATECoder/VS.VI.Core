...
Public Class K7500MeasureControl
...
#Region " RANGE "
    ...
    Public Sub ListRangeModes()
        ...
        With Me._MeterRangeComboBox
            ...
            .DataSource = Nothing
            .Items.Clear()
            .DataSource = GetType(K7500.ResistanceRangeMode).ValueDescriptionPairs
            .ValueMember = "Key"
            .DisplayMember = "Value"
            .Enabled = True
        End With
    ...
    Public Sub SelectMeterRange(ByVal range As Double)
        Me.SelectMeterRange(K7500.SenseResistanceSubsystem.ResistanceRanges.FindResistanceRange(range).Mode)
    End Sub
