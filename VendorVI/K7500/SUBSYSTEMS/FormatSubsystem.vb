''' <summary> Defines a Format Subsystem for a Keithley 7500 Meter. </summary>
...
#Region " I PRESETTABLE "
    ...
    Public Overrides Sub ResetKnownState()
        ...
        Me.Elements = ReadingTypes.Reading
    End Sub
...
#Region " ELEMENTS "
    ...
    ''' <remarks> Only reading is supported. For more info, use the DATA? or READ? commands with arguments. </remarks>
