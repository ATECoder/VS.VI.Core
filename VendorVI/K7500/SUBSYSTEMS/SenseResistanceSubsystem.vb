...
Public Structure ResistanceRange
    Public Sub New(ByVal mode As ResistanceRangeMode, ByVal current As Double, ByVal Range As Double)
        ...
        Me.Range = Range
    End Sub
    Public Mode As ResistanceRangeMode
...
#Region " RANGE "
    ...
    ''' <summary> Gets the resistance range. </summary>
    ''' <value> The resistance range. </value>
    Public ReadOnly Property ResistanceRange As ResistanceRangeCollection
...
#Region " CURRENT "
    ...
    Public Overrides ReadOnly Property Current As Decimal
        Get
            Return CDec(Me.ResistanceRange.FindResistanceRange(Me.Range.GetValueOrDefault(100)).Current)
