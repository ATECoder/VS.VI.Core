...
#Region " SENSE "
    ...
    Private Sub onFunctionModesChanged(ByVal value As VI.Scpi.SenseFunctionModes)
        ...
        If Not VI.Scpi.SenseSubsystemBase.TryParse(value, Me.Device.MeasureSubsystem.Readings.Reading.Unit) Then
            Me.Talker?.Publish(TraceEventType.Warning, My.MyLibrary.TraceEventId,
                               "Failed parsing function mode '{0}' to a standard unit.", value)
        End If
    ...
    Private Sub onFunctionModesChanged(ByVal subsystem As SenseSubsystem)
        If subsystem IsNot Nothing AndAlso subsystem.FunctionModes.HasValue Then
            Dim value As VI.Scpi.SenseFunctionModes = subsystem.FunctionModes.GetValueOrDefault(VI.Scpi.SenseFunctionModes.None)
...
#Region " CONTROL EVENT HANDLERS: SENSE "
    ...
    Private Sub applySenseSettings()
        ...
        If Me.Device.SenseSubsystem.FunctionModes = VI.Scpi.SenseFunctionModes.CurrentDC Then
        ...
        ElseIf Me.Device.SenseSubsystem.FunctionModes = VI.Scpi.SenseFunctionModes.FourWireResistance Then
        ...
        ElseIf Me.Device.SenseSubsystem.FunctionModes = VI.Scpi.SenseFunctionModes.VoltageDC Then
