...
#Region " CONSTRUCTORS  and  DESTRUCTORS "
    ...
    ''' <summary> Initializes a new instance of the <see cref="ThermoStream.Device" /> class. </summary>
    Public Sub New()
        MyBase.New()
...
#Region " SESSION "
    ...
    Protected Overrides Sub OnOpening(ByVal e As ComponentModel.CancelEventArgs)
        ...
        Me._ThermoStreamSubsystem = New ThermostreamSubsystem(Me.StatusSubsystem)
