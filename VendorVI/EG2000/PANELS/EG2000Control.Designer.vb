...
Partial Class EG2000Control
    ...
    Private Sub InitializeComponent()
        ...
        Me._TipsToolTip.SetToolTip(Me._SendMessageLabel, "Message sent to the Prober and processed.")
        '
        '_UnhandledSendLabel
        '
        ...
        Me._TipsToolTip.SetToolTip(Me._UnhandledSendLabel, "Unknown message was sent to the Prober.")
        '
        '_ReceivedGroupBox
        '
        ...
        Me._TipsToolTip.SetToolTip(Me._ReceivedMessageLabel, "Message received from the Prober and processed")
        '
        ...
        Me._TipsToolTip.SetToolTip(Me._UnhandledMessageLabel, "Received unhandled message")
        '
        ...
        Me._TipsToolTip.SetToolTip(Me._ReceivedMessagesGroupBox, "Lists messages received.")
        '
        ...
        Me._TipsToolTip.SetToolTip(Me._CommandComboBox, "Command to send to the Prober")
        '
        '_LastMessageTextBox
        '
