...
#Region " SESSION "
    ...
    Protected Overrides Sub OnOpening(ByVal e As ComponentModel.CancelEventArgs)
        ...
        If Not e.Cancel Then
            ...
            Me.ProberSubsystem = New ProberSubsystem(Me.StatusSubsystem)
        End If
    End Sub
...
#Region " PROBER "
    ...
    Private _ProberSubsystem As ProberSubsystem
    ''' <summary>
    ''' Gets or sets the Prober Subsystem.
    ''' </summary>
    ''' <value>The Prober Subsystem.</value>
    Public Property ProberSubsystem As ProberSubsystem
        Get
            Return Me._ProberSubsystem
        End Get
        Set(value As ProberSubsystem)
            If Me._ProberSubsystem IsNot Nothing Then
                ...
                Me.RemoveSubsystem(Me.ProberSubsystem)
                Me.ProberSubsystem.Dispose()
                Me._ProberSubsystem = Nothing
            End If
            Me._ProberSubsystem = value
            If Me._ProberSubsystem IsNot Nothing Then
                AddHandler Me.ProberSubsystem.PropertyChanged, AddressOf ProberSubsystemPropertyChanged
...
#End If
    ...
    Protected Overrides Sub ProcessServiceRequest()
        ...
        If Not Me.StatusSubsystem.TrySafeQueryDeviceErrors(e) Then
            Dim message As New TraceMessage(TraceEventType.Warning, My.MyLibrary.TraceEventId, $"Failed reading device errors;, details: {e.Details}")
            If Me.Talker Is Nothing Then
