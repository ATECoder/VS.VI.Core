...
#Region " CHANNEL "
    ...
    Protected Overrides ReadOnly Property ClosedChannelQueryCommand As String = ":ROUT:CLOS?"

    ''' <summary> Gets the closed Channel command format. </summary>
    ''' <value> The closed Channel command format. </value>
    Protected Overrides ReadOnly Property ClosedChannelCommandFormat As String = ":ROUT:CLOS {0}"

    ''' <summary> Gets the open Channel command format. </summary>
    ''' <value> The open Channel command format. </value>
    Protected Overrides ReadOnly Property OpenChannelCommandFormat As String = ":ROUT:OPEN {0}"
...
#Region " CHANNELS "
    ...
    Protected Overrides ReadOnly Property ClosedChannelsQueryCommand As String = ":ROUT:MULT:CLOS?"

    ''' <summary> Gets the closed channels command format. </summary>
    ''' <value> The closed channels command format. </value>
    Protected Overrides ReadOnly Property ClosedChannelsCommandFormat As String = ":ROUT:MULT:CLOS {0}"

    ''' <summary> Gets the open channels command format. </summary>
    ''' <value> The open channels command format. </value>
    Protected Overrides ReadOnly Property OpenChannelsCommandFormat As String = ":ROUT:MULT:OPEN {0}"
...
#Region " SLOT CARD TYPE "
    ...
    Protected Overrides ReadOnly Property SlotCardTypeQueryCommandFormat As String = ":ROUT:CONF:SLOT{0}:CTYPE?"
...
#Region " SLOT CARD SETTLING TIME "
    ...
    Protected Overrides ReadOnly Property SlotCardSettlingTimeQueryCommandFormat As String = ":ROUT:CONF:SLOT{0}:STIME?"

    ''' <summary> Gets the slot card settling time command format. </summary>
    ''' <value> The slot card settling time command format. </value>
    Protected Overrides ReadOnly Property SlotCardSettlingTimeCommandFormat As String = ":ROUT:CONF:SLOT{0}:STIME {1}"
