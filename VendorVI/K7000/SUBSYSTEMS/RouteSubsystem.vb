...
#Region " CHANNEL "
    ...
    Protected Overrides ReadOnly Property ClosedChannelQueryCommand As String = ":ROUT:CLOS:STATE?"
...
#Region " CHANNELS "
    ...
    Protected Overrides ReadOnly Property ClosedChannelsQueryCommand As String = ":ROUT:CLOS:STATE?"
...
#Region " SLOT CARD TYPE "
    ...
    Protected Overrides ReadOnly Property SlotCardTypeCommandFormat As String = ":ROUT:CONF:SLOT{0}:CTYPE{1}"

#End Region

#Region " SLOT CARD SETTL:IONG TIME "
