...
Public Class ArmLayer1Subsystem
...
#Region " I PRESETTABLE "
    ...
    Public Overrides Sub InitKnownState()
        ...
        Me.SupportedArmSources = Scpi.ArmSources.Bus Or Scpi.ArmSources.External Or Scpi.ArmSources.Hold Or Scpi.ArmSources.Immediate Or
                                 Scpi.ArmSources.Manual Or Scpi.ArmSources.TriggerLink
    End Sub
...
#Region " COMMANDS "
    ...
    Protected Overrides ReadOnly Property ImmediateCommand As String = ":ARM:LAY1:IMM"
...
#Region " ARM COUNT "
    ...
    Protected Overrides ReadOnly Property ArmCountQueryCommand As String = ":ARM:LAY1:COUN?"

    ''' <summary> Gets Arm count command format. </summary>
    ''' <value> The Arm count command format. </value>
    Protected Overrides ReadOnly Property ArmCountCommandFormat As String = ":ARM:LAY1:COUN {0}"
...
#Region " DIRECTION (BYPASS) "
    ...
    Protected Overrides ReadOnly Property DirectionQueryCommand As String = ":ARM:LAY1:TCON:DIR?"

    ''' <summary> Gets the Trigger Direction command format. </summary>
    ''' <value> The Trigger Direction command format. </value>
    Protected Overrides ReadOnly Property DirectionCommandFormat As String = ":ARM:LAY1:TCON:DIR {0}"
...
#Region " ARM SOURCE "
    ...
    Protected Overrides ReadOnly Property ArmSourceCommandFormat As String = ":ARM:LAY1:SOUR {0}"

    ''' <summary> Gets the Arm source query command. </summary>
    ''' <value> The Arm source query command. </value>
    Protected Overrides ReadOnly Property ArmSourceQueryCommand As String = ":ARM:LAY1:SOUR?"
...
#Region " DELAY "
    ...
    Protected Overrides ReadOnly Property DelayCommandFormat As String = "" ' ":ARM:LAY1:DEL {0:s\.fff}"
    ...
    ''' <value> The delay query command. </value>
    Protected Overrides ReadOnly Property DelayQueryCommand As String = "" ' ":ARM:LAY1:DEL?"
...
#Region " INPUT LINE NUMBER "
    ...
    Protected Overrides ReadOnly Property InputLineNumberCommandFormat As String = ":ARM:LAY1:TCON:ASYN:ILIN {0}"

    ''' <summary> Gets the Input Line Number query command. </summary>
    ''' <value> The Input Line Number query command. </value>
    Protected Overrides ReadOnly Property InputLineNumberQueryCommand As String = ":ARM:LAY1:TCON:ASYN:ILIN?"
...
#Region " OUTPUT LINE NUMBER "
    ...
    Protected Overrides ReadOnly Property OutputLineNumberCommandFormat As String = ":ARM:LAY1:TCON:ASYN:OLIN {0}"

    ''' <summary> Gets the Output Line Number query command. </summary>
    ''' <value> The Output Line Number query command. </value>
    Protected Overrides ReadOnly Property OutputLineNumberQueryCommand As String = ":ARM:LAY1:TCON:ASYN:OLIN?"
...
#Region " TIMER TIME SPAN "
    ...
    Protected Overrides ReadOnly Property TimerIntervalCommandFormat As String = "" ' ":ARM:LAY1:TIM {0:s\.FFFFFFF}"
    ...
    ''' <value> The Timer Interval query command. </value>
    Protected Overrides ReadOnly Property TimerIntervalQueryCommand As String = "" ' ":ARM:LAY1:TIM?"
