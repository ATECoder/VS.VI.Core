...
#Region " CONSTRUCTORS  and  DESTRUCTORS "
    ...
    Public Sub New()
        MyBase.New()
        AddHandler My.Settings.Default.PropertyChanged, AddressOf Me._Settings_PropertyChanged
    End Sub
...
#Region " MY SETTINGS "
    ...
    Public Shared Sub OpenSettingsEditor()
        Using f As Core.Pith.ConfigurationEditor = Core.Pith.ConfigurationEditor.Get
            ...
            f.ShowDialog(isr.VI.Tsp2.K7500.My.Settings.Default)
        End Using
    End Sub
    ...
    ''' <param name="sender">       Source of the event. </param>
    ''' <param name="propertyName"> Name of the property. </param>
    Private Sub OnSettingsPropertyChanged(ByVal sender As My.Settings, ByVal propertyName As String)
        If sender Is Nothing OrElse String.IsNullOrWhiteSpace(propertyName) Then Return
        Select Case propertyName
    ...
    Private Sub _Settings_PropertyChanged(sender As Object, e As ComponentModel.PropertyChangedEventArgs)
        Dim settings As My.Settings = TryCast(sender, My.Settings)
