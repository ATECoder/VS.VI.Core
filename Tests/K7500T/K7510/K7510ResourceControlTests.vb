...
Namespace K7500.Tests
    ...
    <TestClass()>
    Public Class K7510ResourceControlTests
...
#Region " DEVICE OPEN TEST "
        ...
        Public Sub OpenSessionTwiceTest()
            ...
            Using device As VI.K7500.Device = VI.K7500.Device.Create
                ...
                End Using
                Using control As VI.Instrument.ResourceControlBase = VI.Instrument.ResourceControlBase.Create(device, False)
                    K7510Manager.OpenCloseSession(2, control)
                End Using
                Using control As VI.Instrument.ResourceControlBase = VI.Instrument.ResourceControlBase.Create(device, False)
                    K7510Manager.OpenCloseSession(3, control)
                    sw.Wait(TimeSpan.FromMilliseconds(100))
                    K7510Manager.OpenCloseSession(4, control)
                End Using
            End Using
        End Sub
