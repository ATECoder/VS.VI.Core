...
#Region " CONSTRUCTION AND CLEANUP "
    ...
    Public Shared Sub MyClassInitialize(ByVal testContext As TestContext)
        Try
            ...
            control = New isr.VI.Tsp.K3700.BridgeMeterControl
    ...
    Public Shared Sub MyClassCleanup()
        ...
        If device IsNot Nothing Then device.Dispose() : device = Nothing
    End Sub
...
#Region " SHARED CONTROL AND DEVICE "
    ...
    Private Shared control As isr.VI.Tsp.K3700.BridgeMeterControl
