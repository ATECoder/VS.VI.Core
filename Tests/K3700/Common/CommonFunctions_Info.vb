...
#Region " DEVICE INFORMATION "
    ...
    Private Shared _ResourcePinged As Boolean?

    ''' <summary> Gets the resource pinged. </summary>
    ''' <value> The resource pinged. </value>
    Public Shared ReadOnly Property ResourcePinged As Boolean
        Get
            If Not TestInfo._ResourcePinged.HasValue Then
                TestInfo._ResourcePinged = Not String.IsNullOrWhiteSpace(TestInfo.ResourceName)
            End If
            Return TestInfo._ResourcePinged.Value
        End Get
    End Property
