...
#Region " TRACE MESSAGE QUEUE COLLECTION "
    ...
    Private Class TraceMessasgeQueueCollection
        ...
        Public Sub New()
            ...
            Me.Add(Core.Pith.My.MyLibrary.UnpublishedTraceMessages)
            Me.Add(VI.My.MyLibrary.UnpublishedTraceMessages)
            Me.Add(VI.Scpi.My.MyLibrary.UnpublishedTraceMessages)
            Me.Add(VI.E4990.My.MyLibrary.UnpublishedTraceMessages)
        End Sub
