...
#Region " VERSION TESTS "
    ...
    Public Sub ValidateVisaVersionTest()
        ...
        isr.VI.Pith.ResourcesManagerBase.ValidateFoundationSystemFileVersion(e)
        Assert.IsFalse(e.Cancel, $"Invalid foundation VISA System file version: {e.Details}")
        isr.VI.Pith.ResourcesManagerBase.ValidateFoundationVisaAssemblyVersion(e)
        Assert.IsFalse(e.Cancel, $"Invalid foundation VISA .NET file version: {e.Details}")
        isr.VI.Pith.ResourcesManagerBase.ValidateVendorVersion(e)
