Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Public Const AssemblyProduct As String = "VI.Device.Console.2018"
        ...
        Public Shared Sub Identify(ByVal talker As isr.Core.Pith.ITraceMessageTalker)
            ...
            If DateTime.Now.Date > My.MyApplication.IdentifyDate AndAlso talker.Listeners.Any AndAlso talker.Listeners.ContainsLoggerListener Then
