    ...
    Private Sub _OpenButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _OpenButton.Click
        ...
        Select Case Me.selectedAction
            ...
            Case ActionOption.Keithley7510
                Me._OpenForms.ShowNew("Meter", New Core.Pith.ConsoleForm, New K7500.K7500Panel, My.Application.MyLog, True)
            Case ActionOption.Electroglass2000
                Me._OpenForms.ShowNew("Prober", New Core.Pith.ConsoleForm, New EG2000.EG2000Panel, My.Application.MyLog, True)
