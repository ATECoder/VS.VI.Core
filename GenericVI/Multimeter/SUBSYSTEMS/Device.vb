...
''' <summary> Implements a generic multimeter device. </summary>
...
#Region " STATUS "
    ...
    Protected Overloads Sub StatusSubsystemPropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs)
        ...
        Dim activity As String = $"handling {NameOf(Multimeter.StatusSubsystem)}.{e.PropertyName} change"
        Try
            Me.HandlePropertyChange(TryCast(sender, Multimeter.StatusSubsystem), e.PropertyName)
        Catch ex As Exception
