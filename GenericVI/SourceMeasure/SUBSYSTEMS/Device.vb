...
#Region " MIXED SUBSYSTEMS: OUTPUT / MEASURE "
    ...
    Public Sub OutputOn(ByVal voltage As Double, ByVal currentLimit As Double, ByVal overvoltageLimit As Double)
        ...
        Me.SourceSubsystem.WriteFunctionMode(Scpi.SourceFunctionModes.VoltageDC)
        ...
        Me.SenseSubsystem.ApplyFunctionModes(VI.SourceMeasure.SenseFunctionModes.Current Or VI.SourceMeasure.SenseFunctionModes.Voltage)
