...
#Region " SESSION "
    ...
    Private ReadOnly Property GpibInterface As NationalInstruments.VisaNS.GpibInterface
    ...
    Private Sub _OpenSession(ByVal resourceName As String, ByVal timeout As TimeSpan)
        Me._GpibInterface = New NationalInstruments.VisaNS.GpibInterface(resourceName,
                                                                         NationalInstruments.VisaNS.AccessModes.NoLock,
    ...
    Private Sub _CloseSession()
        If Me._GpibInterface IsNot Nothing Then
            Me._GpibInterface.DiscardEvent(NationalInstruments.VisaNS.GpibInterfaceEventType.AllEnabledEvents)
