...
#Region " PARSE READING "
    ...
    ''' <summary> Safe post measured value. </summary>
    Public Sub SafePostMeasuredValue()
        Me.SafePostPropertyChanged(NameOf(MeasureSubsystemBase.MeasuredValue))
    End Sub

    ''' <summary> Safe send measured value. </summary>
    Public Sub SafeSendMeasuredValue()
        Me.SafePostPropertyChanged(NameOf(MeasureSubsystemBase.MeasuredValue))
    End Sub
...
#Region " MEASURE "
    ...
    Public Function MeasureValue(ByVal queryCommand As String) As Double?
    ...
    Public Function Measure(ByVal queryCommand As String) As Double?
        Dim value As String = Me.Query(Me.Session.EmulatedReply, queryCommand)
