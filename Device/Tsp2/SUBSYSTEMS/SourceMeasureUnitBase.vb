...
#Region " MAXIMUM OUTPUT POWER "
    ...
    Public Overloads Property MaximumOutputPower As Double
        Get
            Return Me._MaximumOutputPower
        End Get
        Set(ByVal value As Double)
            If Not Nullable.Equals(Me.MaximumOutputPower, value) Then
                Me._MaximumOutputPower = value
                Me.SafePostPropertyChanged()
            End If
        End Set
    End Property
    ...
    Public Function MaximumCurrent(ByVal sourceVoltage As Double) As Double
        Return Me.MaximumOutputPower / sourceVoltage
    End Function

    ''' <summary> Maximum voltage. </summary>
    ''' <param name="sourceCurrent"> Source current. </param>
    ''' <returns> A Double. </returns>
    Public Function MaximumVoltage(ByVal sourceCurrent As Double) As Double
        Return Me.MaximumOutputPower / sourceCurrent
    End Function
