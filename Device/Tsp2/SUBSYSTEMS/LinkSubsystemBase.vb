...
#Region " CONTROLLER NODE "
    ...
    Public Sub InitiateControllerNode()
        If Me.ControllerNode Is Nothing Then
            ...
            Me.SafePostPropertyChanged(NameOf(Tsp2.LinkSubsystemBase.ControllerNodeModel))
...
#Region " TSP: NODE ENTITIES "
    ...
    Private Sub AddNodeEntity(ByVal nodeNumber As Integer)
        ...
        Else
            Dim node As Tsp2.NodeEntity = New NodeEntity(nodeNumber, Me.ControllerNodeNumber.Value)
    ...
    Public Sub EnumerateNodes(ByVal maximumCount As Integer)
        ...
        If maximumCount > 1 Then
            ...
            Next
        End If
        Me.SafePostPropertyChanged(NameOf(Tsp2.LinkSubsystemBase.NodeCount))
    End Sub
