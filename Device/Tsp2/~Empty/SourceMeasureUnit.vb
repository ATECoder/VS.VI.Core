...
#Region " I PRESETTABLE "
    ...
    Public Overrides Sub ResetKnownState()
        ...
        Me.ContactCheckSpeedMode = New Tsp2.ContactCheckSpeedMode?
...
#Region " CONTACT CHECK "
    ...
    Public Function CheckContacts(ByVal threshold As Integer) As Boolean?
        ...
        If Not Me.ContactCheckSpeedMode.Equals(Tsp2.ContactCheckSpeedMode.Fast) Then
            Me.Session.LastAction = Me.Talker?.Publish(TraceEventType.Information, My.MyLibrary.TraceEventId,
                                                       "writing contact mode {0};. ", Tsp2.ContactCheckSpeedMode.Fast)
            Me.WriteContactCheckSpeedMode(Tsp2.ContactCheckSpeedMode.Fast)
