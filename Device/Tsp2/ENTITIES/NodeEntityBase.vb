...
#Region " CONSTRUCTORS "
    ...
    Protected Sub New(ByVal number As Integer, ByVal controllerNodeNumber As Integer)
        ...
        Me._modelNumber = ""
        Me._InstrumentModelFamily = Tsp2.InstrumentModelFamily.None
        Me._FirmwareVersion = ""
        Me._SerialNumber = ""
    End Sub
...
#Region " INSTRUMENT MODEL "
    ...
    ''' <returns> A <see cref="Tsp2.InstrumentModelFamily">model family</see>. </returns>
    Public Shared Function ParseModelNumber(ByVal value As String) As Tsp2.InstrumentModelFamily
        For Each item As Tsp2.InstrumentModelFamily In [Enum].GetValues(GetType(Tsp2.InstrumentModelFamily))
            If item <> 0 AndAlso NodeEntityBase.IsModelMatch(value, ModelFamilyMask(item)) Then
                Return item
            End If
        Next
        Return Tsp2.InstrumentModelFamily.None
    End Function
    ...
    Public Shared Function ModelFamilyMask(ByVal value As Tsp2.InstrumentModelFamily) As String
        Select Case value
            Case Tsp2.InstrumentModelFamily.K2450
                Return "245%"
            Case Tsp2.InstrumentModelFamily.K7500
                Return "75%%"
            Case Else
    ...
    Public Shared Function ModelFamilyResourceFileSuffix(ByVal value As Tsp2.InstrumentModelFamily) As String
        Select Case value
            Case Tsp2.InstrumentModelFamily.K2450
                Return ".2450"
            Case Tsp2.InstrumentModelFamily.K7500
...
Public Enum InstrumentModelFamily
    ...
    <System.ComponentModel.Description("245x Source Meters")> K2450 = 1

    ''' <summary>75xx meters.</summary>
    <System.ComponentModel.Description("75xx Meters")> K7500 = 2
