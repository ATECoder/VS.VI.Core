...
#Region " I PRESETTABLE "
    ...
    Private Sub _ResetKnownState()
        ...
        Me._ArmCount = 0
        Me._ArmDirection = Scpi.Direction.Acceptor
        Me._ArmSource = Scpi.ArmSources.Immediate
        Me._TriggerDirection = Scpi.Direction.Acceptor
        Me._TriggerSource = Scpi.TriggerSources.Immediate
    End Sub
