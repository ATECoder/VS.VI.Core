    ...
    Protected Overrides Sub HandlePropertyChange(ByVal device As VI.DeviceBase, ByVal propertyName As String)
        ...
        Select Case propertyName
            ...
            Case NameOf(isr.VI.DeviceBase.MessageNotificationLevel)
                VI.Pith.SessionBase.SelectItem(Me._SessionNotificationLevelComboBox, device.Session.MessageNotificationLevel)
...
#Region " STATUS "
    ...
    ''' <param name="propertyName"> Name of the property. </param>
    Private Overloads Sub HandlePropertyChange(ByVal subsystem As Scpi.Instrument.StatusSubsystem, ByVal propertyName As String)
    ...
    Private Sub StatusSubsystemPropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs)
        ...
        Dim activity As String = $"handling {NameOf(Scpi.Instrument.StatusSubsystem)}.{e.PropertyName} change"
        Try
            ...
            Else
                Me.HandlePropertyChange(TryCast(sender, Scpi.Instrument.StatusSubsystem), e.PropertyName)
            End If
        Catch ex As Exception
...
#Region " SYSTEM "
    ...
    Private Sub SystemSubsystemPropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs)
        If Me.InitializingComponents OrElse sender Is Nothing OrElse e Is Nothing Then Return
        Dim activity As String = $"handling {NameOf(Scpi.Instrument.SystemSubsystem)}.{e.PropertyName} change"
        Try
            If Me.InvokeRequired Then
                Me.Invoke(New Action(Of Object, PropertyChangedEventArgs)(AddressOf Me.SystemSubsystemPropertyChanged), New Object() {sender, e})
            Else
                Me.HandlePropertyChange(TryCast(sender, Scpi.Instrument.SystemSubsystem), e.PropertyName)
            End If
        Catch ex As Exception
            If Me.Talker Is Nothing Then
                My.MyLibrary.LogUnpublishedException(activity, ex)
